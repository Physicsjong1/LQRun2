...
void ana_lq(){
  ...
  auto df_S1_ttbar_categorize = df_S1_cjets.Filter("genTtbarId > 0","ttbar events")
                                           .Define("ttbarAdditionalJetID","genTtbarId % 100")
  ...
  //d1->Print();
  auto df_S1_tagged_jets = df_S1_ttbar_categorize.Define("cjet_pt","Jet_pt[goodcjets]")
  ...
  auto h_ttb_bjet_pt = df_S1_ttbar_categorize.Define("ttb_bjet1_pt","Jet_pt[goodbjets_m && ttb][0]")
                                              .Histo1D({"h_ttb_bjet1_pt","h_ttb_bjet1_pt",60,0,300},"ttb_bjet1_pt");
  auto h_ttb_cjet_pt = df_S1_ttbar_categorize.Define("ttb_cjet1_pt","Jet_pt[goodcjets && ttb][0]")
                                              .Histo1D({"h_ttb_cjet1_pt","h_ttb_cjet1_pt",60,0,300},"ttb_cjet1_pt");
  ...
  auto h_ttc_bjet_pt = df_S1_ttbar_categorize.Define("ttc_bjet1_pt","Jet_pt[goodbjets_m && ttc][0]")
                                              .Histo1D({"h_ttc_bjet1_pt","h_ttc_bjet1_pt",60,0,300},"ttc_bjet1_pt");
  auto h_ttc_cjet_pt = df_S1_ttbar_categorize.Define("ttc_cjet1_pt","Jet_pt[goodcjets && ttc][0]")
                                              .Histo1D({"h_ttc_cjet1_pt","h_ttc_cjet1_pt",60,0,300},"ttc_cjet1_pt");
  ...
  auto h_ttlf_bjet_pt = df_S1_ttbar_categorize.Define("ttlf_bjet1_pt","Jet_pt[goodbjets_m && ttlf][0]")
                                              .Histo1D({"h_ttlf_bjet1_pt","h_ttlf_bjet1_pt",60,0,300},"ttlf_bjet1_pt");
  auto h_ttlf_cjet_pt = df_S1_ttbar_categorize.Define("ttlf_cjet1_pt","Jet_pt[goodcjets && ttlf][0]")
                                              .Histo1D({"h_ttlf_cjet1_pt","h_ttlf_cjet1_pt",60,0,300},"ttlf_cjet1_pt");
  ...
  auto df_S1_kinematics = df_S1_tagged_jets.Define("ctau_dR",calculate_dr,{"cjet_eta","good_tau_eta","cjet_phi","good_tau_phi"})
  ...
  auto h_ttb_ctau_dR = df_S1_ctau_dR.Filter("ttb","ttb").Histo1D({"h_ttb_ctau_dR","h_ttb_ctau_dR",25,0,5},"ctau_dR");
  auto h_ttb_ctau_M = df_S1_ctau_dR.Filter("ttb","ttb").Histo1D({"h_ttb_ctau_M","h_ttb_ctau_M",100,0,500},"ctau_M");
  auto h_ttc_ctau_dR = df_S1_ctau_dR.Filter("ttc","ttc").Histo1D({"h_ttc_ctau_dR","h_ttc_ctau_dR",25,0,5},"ctau_dR");
  auto h_ttc_ctau_M = df_S1_ctau_dR.Filter("ttc","ttc").Histo1D({"h_ttc_ctau_M","h_ttc_ctau_M",100,0,500},"ctau_M");
  auto h_ttlf_ctau_dR = df_S1_ctau_dR.Filter("ttlf","ttlf").Histo1D({"h_ttlf_ctau_dR","h_ttlf_ctau_dR",25,0,5},"ctau_dR");
  auto h_ttlf_ctau_M = df_S1_ctau_dR.Filter("ttlf","ttlf").Histo1D({"h_ttlf_ctau_M","h_ttlf_ctau_M",100,0,500},"ctau_M");
  ...
  plot( h_ttb_bjet_pt, "h_ttb_bjet1_pt");
  plot( h_ttb_cjet_pt, "h_ttb_cjet1_pt");
  plot( h_ttb_muon_pt, "h_ttb_muon_pt");
  plot( h_ttb_tau_pt, "h_ttb_tau_pt");
  plot( h_ttc_bjet_pt, "h_ttc_bjet1_pt");
  plot( h_ttc_cjet_pt, "h_ttc_cjet1_pt");
  plot( h_ttc_muon_pt, "h_ttc_muon_pt");
  plot( h_ttc_tau_pt, "h_ttc_tau_pt");
  plot( h_ttlf_bjet_pt, "h_ttlf_bjet1_pt");
  plot( h_ttlf_cjet_pt, "h_ttlf_cjet1_pt");
  ...
  auto report = df_S1_ctau_dR.Report();
  report->Print();
